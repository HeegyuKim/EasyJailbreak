...
class Qwen2Prompter(BasePrompter, ABC):
    ...
    def format_history_prefix(
        ...
        prompt = "" if system_message is None else f"<|SYSTEM|>{system_message}{self.end_of_turn_token}"
    ...
    def format_message(
        ...
        sys_pr = "" if system_message is None else f"<|SYSTEM|>{system_message}{self.end_of_turn_token}"
